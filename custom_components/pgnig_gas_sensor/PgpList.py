...
class PpgListElement:
    ...
    def from_dict(obj: Any) -> 'PpgListElement':
        ...
        return PpgListElement(id_ppg, meter_number, reading_date_utc, contract_number, has_t12, reading_added,
                              tariff, has_history, type, id_local, client_number, installation_number, color,
                              agreement_name, can_create_home_assistant, add_reading_mode, is_in_migration,
                              is_in_migration_rk, is_in_migration_rw, is_company)
...
class PpgList:
    ...
    @staticmethod
    def from_dict(obj: dict) -> 'PpgList':
        assert isinstance(obj, dict)
        ...
        return PpgList(ppg_list, code, message, display_to_end_user, end_user_message, token_expire_date,
                       token_expire_date_utc)
